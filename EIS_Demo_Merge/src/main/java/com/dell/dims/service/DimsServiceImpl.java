...
public class DimsServiceImpl {
    ...
    private static Logger logger = LoggerFactory.getLogger(DimsServiceImpl.class);
  ...
  /*  public MultiValueMap getMultiValueMapTibcoAdapter() {
    ...
    public String process(DimsDTO dimsDTO) {
        try {
            ...
            //test code for direct copy from src app to destination app
            //In Generic code comment this code
            if(1==1)
            {
                return "";
            }
                ...
                try {
                    ...
                    if(pd!=null)
                    {
                        ...
                        if(starterProcessCounter==1) // create global variables only once a application
                        {
                            ...
                            String variableDir = DimsServiceImpl.input_project_path + File.separator + "defaultVars";
                            String destDirectory = DimsServiceImpl.output_project_path;
                    ...
                    FileUtility.writeFile(DimsServiceImpl.output_project_path + File.separator + "Logs" ,"ActivitiesWithoutParserOrBuilder.log", missingDataLog.toString());
